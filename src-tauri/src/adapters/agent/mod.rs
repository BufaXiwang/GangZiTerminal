...
//!
//! Spec: docs/design/agent-infra-module.md §5（对外接口 / Skill Registry API）
//!
//! 本目录暴露：
//! - `cmd::agent_list_skills`：introspection command
//! - `events::AGENT_EVENT` + `wrap_agent_event`：前端 listen 用的事件名常量
//!
//! Runtime（Phase 3）会向 `AgentInfra.registry` 注入 Quotes / News / Account facade skill，
