...
use crate::agent::provider::{ChatProvider, ProviderError, ProviderEvent, TokenUsage};
...
mod tests {
    ...
    use crate::agent::types::ThinkingDisplay;
    ...
    fn build_request_body_emits_effort_in_output_config() {
        ...
        let mut req = dummy_request();
        req.options.thinking = None;
        req.options.effort = Some(crate::agent::types::EffortLevel::XHigh);
        let body = provider.build_request_body(&req);
